...
export default function StatCard({ stat, index }) {
  return (
    <div
      ...
      className='relative group transition-transform transition-shadow duration-300 hover:-translate-y-2 hover:scale-105 about-stat-item'
    >
      <div className="text-center p-5 md:p-6 rounded-2xl glass-card h-full relative overflow-hidden border-2 border-primary-500/20 group-hover:border-primary-500/60 transition-border-color transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-primary-500/20" title={stat.tooltip || ''}>
